...
function doOnLoad() {
		...
		const rootLayout = new dhtmlXLayoutObject({
			  ...
			  pattern: '1C',
			  cells: [{id: "a",header: false,text: 'Referensi Persediaan'}],
...
function openRequestDetails(windows, options) {
		  ...
		  const winTitle = ['ubah', 'view'].includes(MODE) ? `Referensi Persediaan - ${options.id}` : 'Referensi Persediaan Baru';
...
//					format: () => '<a href="javascript:void(0);" onclick="showCabang();"><img border="0" src="../../assets/imgs/ic_search.gif" style="border:1px solid #a4bed4; padding:2px;" ></a>',
			...
			{type: "combo", label: "Form : ",required: true,name:"typereff", connector: "../../libs/utils.php?mode=cboforminv",value: "",inputWidth: 330},
