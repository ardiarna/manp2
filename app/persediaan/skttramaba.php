...
function doOnLoad() {
		...
		const rootLayout = new dhtmlXLayoutObject({
				...
				pattern: '2E',
				cells: [
					{id: "a", text: "Transaksi Barang Masuk", header: true,height:80},
		...
		const toolbar = rootLayout.cells("b").attachToolbar(
		 {
			 iconset: 'awesome',
			 xml:"../../libs/toolbar.php?id=stk207"
		});
...
function openRequestDetails(windows, options) {
			  ...
			  return true;
				...
				{type: "block",width: 800,blockOffset: 20,list:[
						...
						{type:"newcolumn"},
						{
							type: 'template',
							name: 'reffbr',
							format: () => '<a href="javascript:void(0);" onclick="showReffWindow(windows,entryForm,\'INVTM\',[\'reff\',\'reffdesc\',\'kodecabang\',\'namacabang\']);"><img border="0" src="../../assets/imgs/ic_search.gif" style="border:1px solid #a4bed4; padding:2px;" ></a>',
							inputWidth: 25
						},
						{type:"newcolumn"},
	...
	myGrid2.setHeader("Kode Barang,Nama,Satuan,Qty Stock,Qty Masuk",null,
