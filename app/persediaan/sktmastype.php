...
function doOnLoad() {
        ...
        grid_reff.setHeader("No.,Kode Jenis,Keterangan,Jenis,User Buat,Tanggal Buat,User Edit,Tanggal Edit", null,
        ...
        grid_reff.setInitWidths("50,100,*,100,100,100,120,120");
...
function openRequestDetails(windows, options) {
		  ...
		  const winTitle = ['ubah', 'view'].includes(MODE) ? `Jenis Barang - ${options.id}` : 'Jenis Barang Baru';
		...
		{type: "block", offsetTop:0,offsetLeft:20,blockOffset: 0,list:[
			...
			{type: 'input', name: 'kodesat', label: 'Kode Jenis : ', maxLength: 3,inputWidth: 100,required: true,maxlength:3},
			{type: 'input', name: 'nama', label: 'Nama : ', inputWidth: 330},
			{type:"combo", name: "jnsbrg",label: 'Type : ',  inputWidth: 150,options: [
							{text: "Inventory",value:"I"},
							{text: "Non Inventory",value:"N"},
			]},
		]},
