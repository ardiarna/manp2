...
$i=1;
$sql = "select *from pc_mas_supplier;
";
//echo $sql;
$query=pg_query($app_conn,$sql);
	while($row=pg_fetch_array($query)){
		//echo $row['KodePerusahaan'];
		echo ("<row id='".$row['pcms_code']."'>");
		print("<cell><![CDATA[".$i."]]></cell>");
		print("<cell><![CDATA[".$row['pcms_code']."]]></cell>");
		print("<cell><![CDATA[".$row['pcms_name']."]]></cell>");
		print("<cell><![CDATA[]]></cell>");
		print("<cell><![CDATA[".$row['pcms_pic1']."]]></cell>");
		print("<cell><![CDATA[".$row['pcms_job1']."]]></cell>");
		print("<cell><![CDATA[".$row['pcms_hp01']."]]></cell>");
		print("<cell><![CDATA[".$row['pcms_pic2']."]]></cell>");
		print("<cell><![CDATA[".$row['pcms_job2']."]]></cell>");
		print("<cell><![CDATA[".$row['pcms_hp02']."]]></cell>");
		print("<cell><![CDATA[".$row['pcms_pic3']."]]></cell>");
		print("<cell><![CDATA[".$row['pcms_job3']."]]></cell>");
		print("<cell><![CDATA[".$row['pcms_hp03']."]]></cell>");
		print("<cell><![CDATA[".$row['pcms_addr']."]]></cell>");
		print("</row>");
		$i++;
}
echo '</rows>';
