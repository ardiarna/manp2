...
class PostgresqlDatabase
{
    ...
    /**
     * Closes the DB connection and frees the connection pool.
     * No query can be initiated to the DB after connection.
     *
    ...
    /**
     * Try to reconnect to the database using connection params in the DB.
     * Method will do nothing if the connection has been initiated.
     */
