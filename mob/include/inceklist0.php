...
function display_node($ceklist_code, $parent, $padding) {
	...
	while($r=pg_fetch_array($query)) {
		...
		$out .= '<tr><td class="text-center" style="max-width:200px;">'.$no.'</td><td style="padding-left:'.$padding.'px;"><input type="hidden" name="cd_code[]" value="'.$r[cd_code].'">'.$no2.' '.$r[cd_name].'</td><td class="text-center"><label class="radio-inline" style="margin-left: 40px;"><input type="radio" name="cd_value_'.$r[cd_code].'" value="V"> V </label><label class="radio-inline" style="margin-left: 40px;"><input type="radio" name="cd_value_'.$r[cd_code].'" value="X"> X </label></td><td class="text-center"><input type="text" class="form-control input-sm" name="cd_note_'.$r[cd_code].'"></td></tr>';
		if ($r[am_count] > 0) {
